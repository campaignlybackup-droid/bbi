INSERT INTO blog_posts (
  title, slug, content, excerpt, featured_image, category, tags, author_id, status, published_at, meta_description
) VALUES (
  'India MSME Sector 2026: The ₹30 Lakh Crore Credit Gap, Digital Revolution & What It Means for 7.86 Crore Businesses',
  ...
  .tc-box.problem li::before { content: ''✕''; color: #c0392b; font-size: 12px; }
  .tc-box.solution li::before { content: ''✓''; color: var(--green); font-size: 13px; font-weight: 700; }
...
<main class="bbi-article">
  ...
  'A data-first breakdown of India''s 7.86 crore small businesses — their power, their problems, and the digital shifts rewriting the rules in 2026.',
  '',
  'Indian Business',
  'MSME, Small Business India, Indian Economy, Digital Lending, Udyam, GeM, MUDRA',
  (SELECT id FROM admins LIMIT 1),
  'published',
  CURRENT_TIMESTAMP,
  'India''s 7.86 crore MSMEs contribute 31% of GDP and 48% of exports — yet face a ₹30 lakh crore credit gap. Here''s the definitive 2026 breakdown of the challenges, digital reforms, and opportunities shaping India''s small business engine.'
);
