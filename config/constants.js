...
const CSV_REQUIRED_COLUMNS = [
  'business_name', 'category', 'city', 'state', 'address',
  'phone', 'email', 'website', 'google_rating', 'review_count',
  'year_established', 'services', 'facebook', 'instagram', 'linkedin'
];

const BBI_SCORE_WEIGHTS = {
  GOOGLE_RATING: 0.35,
  REVIEW_COUNT: 0.25,
  WEBSITE_PRESENCE: 0.10,
