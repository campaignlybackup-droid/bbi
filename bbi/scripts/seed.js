...
// ADMIN
// ============================================
const adminPassword = bcrypt.hashSync('iphone691', 10);
db.prepare(`INSERT OR IGNORE INTO admins (name, email, password, role) VALUES (?, ?, ?, ?)`)
  .run('BBI Admin', 'applezero', adminPassword, 'superadmin');
...
console.log('📧 Admin login: applezero');
console.log('🔑 Password: iphone691');
db.close();
