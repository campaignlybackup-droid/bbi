...
citiesWithoutSlug.forEach(city => {
...
console.log(\`   Tables: admins, cities, categories, businesses, ranking_history, ranking_scores,
   achievements, business_inquiries, claim_requests, seo_content, related_rankings,
   search_log, trending_searches, page_views, sponsored_listings, ai_jobs, badges, certificates\`);
