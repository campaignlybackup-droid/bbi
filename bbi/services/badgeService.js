...
function generateCertificateSvg(business, rankData) {
  ...
  <text x="300" y="372" fill="rgba(74,85,104,0.6)" font-family="Arial,sans-serif" font-size="8" text-anchor="middle">Independent · Transparent · Updated Monthly · bbi.in</text>
</svg>`;
}
