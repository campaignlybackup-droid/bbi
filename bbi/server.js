...
app.use((req, res, next) => {
  ...
  res.locals.BASE_URL = process.env.BASE_URL || 'https://bbi.in';
  next();
});
...
app.use('/admin/login', authLimiter);        // Rate limit login attempts
...
cron.schedule('0 2 1 * *', () => {
  ...
  console.log('🔄 Running monthly ranking recalculation...');
  try {
    ...
    console.error('❌ Monthly recalculation failed:', e.message);
  }
}, {
